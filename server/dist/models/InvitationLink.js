...
const invitationLinkSchema = new mongoose_1.Schema({
    token: {
        type: String,
        required: true,
        unique: true,
...
const InvitationLink = mongoose_1.default.models.InvitationLink ||
    mongoose_1.default.model("InvitationLink", invitationLinkSchema);
